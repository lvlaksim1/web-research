...
| JS causality | captured fetch/XHR initiator stack + forensic correlation | initiator stack, related action, request and mutation IDs | derivative analysis | `relations.json` | initiator stack is observed; temporal links remain explicitly inferred |
